...
//El metodo "clone" es sobreescrito por el siguiente que arroja una excepción:
    ...
    public void alta(Venta venta) {
        //AGREGADO PARA VALIDAR DUPLICADO DE NUMERO DE TICKET
        int ultimoNroTicket=VentaFacade.getInstance().getUltimoNumeroTicket();
        if(ultimoNroTicket==venta.getNumeroTicket()) venta.setNumeroTicket(ultimoNroTicket+1);
