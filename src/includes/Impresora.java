...
//        String total = caja.getImporte().toString();
        ...
        try {
            ...
            pagina.drawString(" ", 10, 410 + suma);
            pagina.drawString(" ", 10, 430 + suma);
            pagina.drawString(" ", 10, 450 + suma);
            pagina.drawString(" ", 10, 470 + suma);
            pagina.dispose();
            pj.end();
        } catch (Exception e) {
            System.out.println("LA IMPRESION HA SIDO CANCELADA..." + e);
    ...
    public void imprimir(List<MovimientoInterno> movimientos, String tipo) {
        ...
        try {
            ...
            pagina.setColor(Color.black);
            //ORIGINAL
            pagina.drawString("  LA TRADICION CARNICERIAS", 13, suma += 10); //LEER DE BASE NOMBRE DEL NEGOCIO    
